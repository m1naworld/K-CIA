      ...
      <div className="space-y-2">
        {alternatives.map((alt, idx) => (
          <button
            ...
            className="w-full rounded-md border border-slate-200 p-2.5 text-left transition-colors hover:border-emerald-500/50 hover:bg-emerald-50 dark:border-white/10 dark:hover:border-emerald-500/30 dark:hover:bg-emerald-500/5"
          >
