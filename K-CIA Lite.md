...
| 구분 | 기술 스택 | 비고 |
| :---- | :---- | :---- |
| **Frontend** | Next.js (App Router), Deck.gl, react-map-gl | React 기반 3D 지도 시각화 |
| **UI/Styling** | TailwindCSS, shadcn/ui | 모던 UI 컴포넌트 시스템 |
| **Charts** | Recharts 또는 Tremor | 데이터 차트 시각화 |
| **State** | Zustand 또는 Jotai | 경량 상태 관리 |
